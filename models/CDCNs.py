...
#         self.downsample32x32 = nn.Upsample(size=(32, 32), mode='bilinear')
    ...
    def forward(self, x):	    	# x [3, 224, 224]
        ...
        x_Block1 = self.Block1(x)	    	    	# x [224, 112, 112]
#         x_Block1_32x32 = self.downsample32x32(x_Block1)   # x [128, 32, 32]  
        
        x_Block2 = self.Block2(x_Block1)	    # x [112, 56, 56]	  
#         x_Block2_32x32 = self.downsample32x32(x_Block2)   # x [128, 32, 32]  
        
        x_Block3 = self.Block3(x_Block2)	    # x [56, 28, 28]  	
#         x_Block3_32x32 = self.downsample32x32(x_Block3)   # x [128, 32, 32]  
        
        x_Block4 = self.Block4(x_Block3)  # x [28, 14, 14]  	
        
#         x_Block5 = self.Block5(x_Block4)  # x [14, 7, 7]  
        
        out_tri = [x_Block1, x_Block2, x_Block3, x_Block4]
